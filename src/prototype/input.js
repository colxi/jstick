...
import {setupInterface as setupInterface_Mouse} from './input-interfaces/mouse.js';
import {setupInterface as setupInterface_Keyboard} from './input-interfaces/keyboard.js';
...
let Input = function( _instance_ ){
    ...
    */
    ...
    async importInterface( iface ){
        ...
        if( !_instance_.Input.interfaceExist( iface ) ){
    ...
    enableInterface( iface ){
        ...
        if( !_instance_.Input.isInterfaceEnabled( iface ) ){
    ...
    getInterfaceSignals( iface=false ){
        ...
        if( iface ){
            ...
            if( !_instance_.Input.interfaceExist( iface ) ) throw new Error('Unknown Interface');
            if( !_instance_.Input.isInterfaceEnabled( iface ) ) throw new Error('Interface is disabled : '+ iface);
